...
{	
	...
	if (iteration == sh_precision)
		...
		gl_FragColor = vec4(
			0.3 + 0.15 * sin( 0.5 + 3.14 * sin(3.0 + float(number+iteration) / 3.0 + sh_time * 0.3) ),
			0.4 + 0.15 * sin( 0.5 + 3.14 * sin(3.0 + float(number+iteration) / 4.0 + sh_time * 0.5) ),
			0.5 + 0.15 * sin( 0.5 + 3.14 * sin(3.0 + float(number+iteration) / 5.0 + sh_time * 0.7) ),
			255
		);
}